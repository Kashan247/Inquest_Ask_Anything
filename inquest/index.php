	...
	<div class="section-warp ask-me">
		<div class="container clearfix">
			<div class="box_icon box_warp box_no_border box_no_background" box_border="transparent" box_background="transparent" box_color="#FFF">
				<div class="row">
					<div class="col-md-3">
						<h2>Welcome to Inquest</h2>
						<div class="clearfix"></div>
						<p>You can find answers to various questions from different categories on INQUEST. You may ask questions on any topic but will need to register to do so. You can also browse through questions in selected categories of your choice and read all the questions and answers posted by other people.</p>
		...
		<div class="row">
			<div class="col-md-9">
				...
				<div class="tabs-warp question-tab">
		            <ul class="tabs">
		                <li class="tab"><a href="#" class="current"><b> Questions<b></a></li>
